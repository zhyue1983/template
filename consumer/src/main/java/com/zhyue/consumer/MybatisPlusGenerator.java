...
public class MybatisPlusGenerator {
    ...
    private static String projectPath = "/consumer";


    /**
     * 基本包名
     */
    private static String basePackage = "com.zhyue.consumer";
    ...
    private static String url = "jdbc:mysql://localhost:3306/consumer?useSSL=true&requireSSL=false&serverTimezone=UTC";
